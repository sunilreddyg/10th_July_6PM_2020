...
public class Webtable4_Click_InsideCell_BasedOn_Referral_Record {
	...
	public static void main(String[] args) throws Exception 
	{
		...
		for (int i = 1; i < rows.size(); i++) 
		{
			...
			if(Row_text.contains("NESIND"))
			{
				...
				//Target Static Cell and Find List of Links available under cell
		...
		Thread.sleep(5000);
		WebElement News_Data=driver.findElement(By.xpath("//div[@id='tinydata']/table"));
		System.out.println(News_Data.getText());

...
public class ExplicitWait_Text_Text_Presented_At_Value {
	...
	public static void main(String[] args) {
		...
		By Element_location=By.xpath("//input[@data-reactid='198']");
		new WebDriverWait(driver, 30).until(ExpectedConditions.textToBePresentInElementValue(Element_location, "Airtel"));
